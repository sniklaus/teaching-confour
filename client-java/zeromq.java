				...
				do {
					...
					
					{
						if (objectIn.getString("strFunction").equals("ping") == true) {
							...
							objectOut.put("strOut", four.moveNegamax(objectIn.getInt("intDepth"), objectIn.getInt("intDuration")));
							
						} else if (objectIn.getString("strFunction").equals("four_moveAlphabeta") == true) {
							objectOut.put("strOut", four.moveAlphabeta(objectIn.getInt("intDepth"), objectIn.getInt("intDuration")));
