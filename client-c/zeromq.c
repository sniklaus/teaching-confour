			...
			do {
				...
				
				{
					if (strcmp(cJSON_GetObjectItem(objectIn, "strFunction")->valuestring, "ping") == 0) {
						...
						four_moveNegamax(charOut, cJSON_GetObjectItem(objectIn, "intDepth")->valueint, cJSON_GetObjectItem(objectIn, "intDuration")->valueint);
						...
						four_moveAlphabeta(charOut, cJSON_GetObjectItem(objectIn, "intDepth")->valueint, cJSON_GetObjectItem(objectIn, "intDuration")->valueint);
